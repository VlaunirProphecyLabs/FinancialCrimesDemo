def pipe_financial_crimes():
    from datetime import timedelta
    from airflow.providers.databricks.operators.databricks import DatabricksSubmitRunOperator # noqa

    return DatabricksSubmitRunOperator(  # noqa
        task_id = "pipe_financial_crimes",
        json = {
          ...
          "new_cluster": {
            ...
            "spark_conf": {
              ...
              "spark.prophecy.tasks": "{\"pipe_financial_crimes\":\"pipelines/pipe_financial_crimes\"}", 
          ...
          "libraries": [{"maven" : {"coordinates" : "io.prophecy:prophecy-libs_2.12:3.3.0-7.1.66"}},                          {"pypi" : {"package" : "prophecy-libs==1.8.4"}},                          {
        ...
        databricks_conn_id = "pDxkter_HagjydT2QRbfH",
    )
